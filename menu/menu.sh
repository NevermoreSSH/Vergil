...
Exp=$(curl -sS https://raw.githubusercontent.com/NevermoreSSH/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
...
6969) clear ; wget https://raw.githubusercontent.com/NevermoreSSH/Vergil/main2/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;
